...
const CANNED_REPLY =
  "Thanks! I can help with product info, pack sizes, and FAQs. For a quick reply, you can also chat with us on WhatsApp. (Live AI answers arrive in Phase 2.)"
...
export function ChatWidget() {
  ...
  function handleSend() {
    ...
    const botMsg: Message = { id: nextId(), role: 'bot', text: CANNED_REPLY }
        ...
        >
          ...
          <div className="flex items-center justify-between bg-brand-navy px-4 py-3 text-white">
            <div className="flex items-center gap-2">
              <MessageCircle className="h-5 w-5 text-brand-magenta" />
              <span className="font-semibold text-sm">Shreepathy &amp; Co Assistant</span>
            </div>
            <button
          ...
          <div className="border-t border-gray-100 px-4 py-3 bg-gray-50 space-y-2">
            <p className="text-xs text-gray-500 font-medium">Share your details for a callback</p>
