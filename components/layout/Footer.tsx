  ...
  return (
    <footer className="mt-16 border-t border-white/10 bg-brand-navy text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-3 lg:px-8">
        {/* Brand */}
        <div>
          <h2 className="text-lg font-bold">Shreepathy &amp; Co</h2>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-white/70">
            ...
            <li>Email: info@shreepathyandco.com</li>
            <li>
              <a
            ...
            <li>
              <Link href="/contact" className="transition-colors hover:text-brand-magenta">
                Request a Quote
              </Link>
            </li>
          </ul>
