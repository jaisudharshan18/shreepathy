import type { Category, Brand, Product, CustomerProfile, Order, Lead, Enquiry, Faq } from '@/lib/types'
...
export const products: Product[] = [
  ...
  {
    id: 'prod-1', name: 'Pillsbury Cake Premix', slug: 'pillsbury-cake-premix',
    brandId: 'br-1', categoryId: 'cat-1',
    ...
    images: ['/images/placeholder.png'], stockStatus: 'in_stock', isFeatured: true,
  },
  {
    id: 'prod-2', name: "Rich's Whip Topping Cream", slug: 'richs-whip-topping-cream',
    brandId: 'br-2', categoryId: 'cat-1',
  ...
  {
    id: 'prod-3', name: 'Morde Dark Chocolate Compound', slug: 'morde-dark-chocolate-compound',
    brandId: 'br-5', categoryId: 'cat-1',
    description: 'Professional dark chocolate compound ideal for moulding, coating and ganache preparation.',
    variants: [{ size: '400 g', price: 175 }, { size: '1 kg', price: 420 }, { size: '5 kg', price: 2000 }],
    images: ['/images/placeholder.png'],
    modelGlb: '/models/sample.glb',
    stockStatus: 'in_stock', isFeatured: true,
  },
  {
    id: 'prod-4', name: 'Cocoa Powder', slug: 'cocoa-powder',
    brandId: 'br-15', categoryId: 'cat-1',
    ...
    images: ['/images/placeholder.png'], stockStatus: 'low', isFeatured: false,
  },

  // cat-2  Bakery Items
  {
    id: 'prod-5', name: 'Angel Instant Yeast', slug: 'angel-instant-yeast',
    brandId: 'br-13', categoryId: 'cat-2',
    ...
    images: ['/images/placeholder.png'], stockStatus: 'in_stock', isFeatured: false,
  },
  {
    id: 'prod-6', name: 'IFF Bread Improver', slug: 'iff-bread-improver',
    brandId: 'br-3', categoryId: 'cat-2',
  ...
  {
    id: 'prod-7', name: 'Monin Mojito Syrup', slug: 'monin-mojito-syrup',
    brandId: 'br-6', categoryId: 'cat-3',
  ...
  {
    id: 'prod-8', name: 'Mapro Crush', slug: 'mapro-crush',
    brandId: 'br-7', categoryId: 'cat-3',
  ...
  {
    id: 'prod-9', name: 'Veeba Mayonnaise', slug: 'veeba-mayonnaise',
    brandId: 'br-10', categoryId: 'cat-4',
  ...
  {
    id: 'prod-10', name: 'Delmonte Mayonnaise', slug: 'delmonte-mayonnaise',
    brandId: 'br-11', categoryId: 'cat-4',
  ...
  {
    id: 'prod-11', name: 'Cherry Tin', slug: 'cherry-tin',
    brandId: 'br-15', categoryId: 'cat-5',
  ...
  {
    id: 'prod-12', name: 'Mapro Strawberry Crush (Hotel Pack)', slug: 'mapro-strawberry-crush-hotel',
    brandId: 'br-7', categoryId: 'cat-5',
  ...
  // cat-6  Milk Products
  {
    id: 'prod-13', name: 'Amul Butter', slug: 'amul-butter',
    brandId: 'br-8', categoryId: 'cat-6',
  ...
  {
    id: 'prod-14', name: 'Milky Mist Paneer', slug: 'milky-mist-paneer',
    brandId: 'br-9', categoryId: 'cat-6',
  ...
  {
    id: 'prod-15', name: 'Skei Vanilla Ice Cream Base', slug: 'skei-vanilla-ice-cream-base',
    brandId: 'br-14', categoryId: 'cat-7',
  ...
  {
    id: 'prod-16', name: 'Skei Mango Ice Cream Base', slug: 'skei-mango-ice-cream-base',
    brandId: 'br-14', categoryId: 'cat-7',
  ...
  {
    id: 'prod-17', name: 'Frozen Veg Spring Roll', slug: 'frozen-veg-spring-roll',
    brandId: 'br-4', categoryId: 'cat-8',
  ...
  {
    id: 'prod-18', name: 'Mccian French Fries', slug: 'mccian-french-fries',
    brandId: 'br-12', categoryId: 'cat-8',
...
export const customers: CustomerProfile[] = [
  {
    id: 'cust-1', businessName: 'Sweet Layers Bakery', contactName: 'Ramesh Kumar',
    phone: '9876543210', email: 'ramesh@sweetlayers.in',
    tier: 'Gold', pointsBalance: 1250, referralCode: 'SL-RK-001', registeredAt: '2023-06-15',
  },
  {
    id: 'cust-2', businessName: 'The Pizza Corner', contactName: 'Priya Nair',
    phone: '9123456780', email: 'priya@pizzacorner.in',
    tier: 'Silver', pointsBalance: 340, referralCode: 'TPC-PN-002', registeredAt: '2024-01-10',
  },
  {
    id: 'cust-3', businessName: 'Grand Taj Caterers', contactName: 'Suresh Iyer',
    phone: '9988776655', email: 'suresh@grandtaj.in',
    tier: 'Platinum', pointsBalance: 4800, referralCode: 'GTC-SI-003', registeredAt: '2022-11-20',
  },
]
...
export const orders: Order[] = [
  {
    ...
    totalValue: 4200 + 2160, status: 'Delivered', createdAt: '2024-03-12',
  },
  {
    ...
    totalValue: 3750 + 2100, status: 'Processing', createdAt: '2024-05-20',
  },
  {
    id: 'ord-3', customerId: 'cust-3',
    items: [
    ...
    totalValue: 11400 + 9600 + 9200, status: 'Delivered', createdAt: '2024-06-01',
  },
  {
    id: 'ord-4', customerId: 'cust-1',
    items: [
      { productId: 'prod-3', name: 'Morde Dark Chocolate Compound', size: '5 kg', qty: 3, unitValue: 2000 },
    ],
    totalValue: 6000, status: 'Confirmed', createdAt: '2024-06-10',
  },
]
...
export const enquiries: Enquiry[] = [
  {
    id: 'enq-1', name: 'Rajesh Bakeries', phone: '9111222333', business: 'Rajesh Bakeries',
    products: 'Pillsbury Cake Premix, Morde Chocolate', quantity: '50 kg/month',
    location: 'Bangalore', message: 'Need monthly supply for 3 outlets', handled: false, createdAt: '2024-06-12',
  },
  {
    id: 'enq-2', name: 'Faisal Ahmed', phone: '9222333444',
    products: 'Monin Syrups, Mapro Crush', quantity: '24 bottles',
    location: 'Mysore', handled: true, createdAt: '2024-06-08',
  },
  {
    id: 'enq-3', name: 'Savitha Caterers', phone: '9333444555', business: 'Savitha Caterers',
    products: 'Amul Butter, Cherry Tin, Milky Mist Paneer', quantity: 'Bulk',
    location: 'Hubli', message: 'Catering event on 20 June — urgent', handled: false, createdAt: '2024-06-13',
  },
]
...
export const faqs: Faq[] = [
  {
    id: 'faq-1', question: 'What is the minimum order quantity?',
    answer: 'For most products the minimum order is 1 carton or 5 kg. Certain premium items like Monin syrups can be ordered as a single bottle. Contact us on WhatsApp for exact MOQs per SKU.',
  },
  {
    id: 'faq-2', question: 'Which areas do you deliver to?',
    answer: 'We currently deliver across Bangalore, Mysore, Mangalore, Hubli-Dharwad and surrounding districts in Karnataka. Pan-India dispatch is available for orders above ₹10,000 via courier.',
  },
  {
    id: 'faq-3', question: 'What are the payment terms?',
  ...
  {
    id: 'faq-4', question: 'Are all listed brands always available?',
  ...
  {
    id: 'faq-5', question: 'Do you offer samples before bulk orders?',
