...
import type { SiteContentData } from '@/lib/db/content'
...
const DEFAULTS: SiteContentData = {
  ...
  heroSubtext: 'Trusted by bakeries, hotels and restaurants across Karnataka. Order online or on WhatsApp.',
  ctaLabel: 'Shop Now',
...
export default function ContentAdmin({ content }: Props) {
  ...
  return (
    <div className="space-y-8">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {saved && <p className="text-sm text-green-600 mb-3">Saved successfully.</p>}

        <Button type="submit" disabled={isPending}>
          {isPending ? 'Saving…' : 'Save All Content'}
        </Button>
      </form>
    </div>
  )
