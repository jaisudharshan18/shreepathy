...
// ── static mock chat leads (Phase 2e wires real captured leads) ───────────────
...
export default function ChatbotAdmin({ faqs }: Props) {
        ...
        <DialogContent>
          ...
          <form onSubmit={handleAddSubmit}>
            <div className="grid gap-3 py-2">
              ...
              <div className="grid gap-1">
                <Label>Answer</Label>
                <Textarea name="answer" placeholder="Enter answer" required />
              </div>
              <div className="grid gap-1">
